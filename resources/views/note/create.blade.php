        ...
        <form action="{{ route('note.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title"
                    placeholder="Masukkan Judul Catatan" autocomplete="off" value="{{ old('title') }}">
                @error('title')
            ...
            <div class="form-group">
                ...
                placeholder="Berikan Deskripsi Catatan" autocomplete="off" cols="30" rows="10">{{ old('description') }}</textarea>
                @error('description')
